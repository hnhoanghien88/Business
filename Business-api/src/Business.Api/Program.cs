...
builder.Services.AddTransient<IValidator<CreateAreaCommand>, CreateAreaValidator>();
builder.Services.AddTransient<IValidator<UpdateAreaCommand>, UpdateAreaValidator>();
builder.Services.AddTransient<IValidator<CreateTableCommand>, CreateTableValidator>();
builder.Services.AddTransient<IValidator<UpdateTableCommand>, UpdateTableValidator>();
builder.Services.AddTransient<IValidator<SetTableActivationCommand>, SetTableActivationValidator>();
builder.Services.AddTransient<IValidator<OpenTableCommand>, OpenTableValidator>();
builder.Services.AddTransient<IValidator<CloseTableSessionCommand>, CloseTableSessionValidator>();
builder.Services.AddTransient<IValidator<PreviewOrderCommand>, PreviewOrderValidator>();
builder.Services.AddTransient<IValidator<ConfirmOrderCommand>, ConfirmOrderValidator>();
builder.Services.AddTransient<IValidator<PreviewOrderCommand>, PreviewOrderValidator>();
builder.Services.AddTransient<IValidator<ConfirmOrderCommand>, ConfirmOrderValidator>();
